...
#        PROJECT: T-Remix            #
#        Author: Ayanokoji           #
#  email: itz_ayanokoji@outlook.com  #
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO AYANOKOJI TOOLS  \e[m "
echo
...
echo "
        ...
        WELCOME TO AYANOKOJI TOOLS_-^^TOOLS BY ME^^-_ FOLLOW MY GITHUB
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY AYANOKOJI\e[m "
